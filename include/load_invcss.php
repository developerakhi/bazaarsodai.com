...
$getID = $_SESSION['user_id'];
 ...
 $query = "select * from sd_order_more WHERE customerID = '".$getID."' ORDER BY id DESC";
 $ppage = 'all_invoices.php';
      ...
      <table class="table cart-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="table-title">ACTIVITY</th>
									...
									while ($stmt->fetch()) {
										...
										?> 
                                            <tr>
                                                ...
                                                <td class="product-nam"><?php echo $row_member['name'];?><?php echo $customer_name;?></td>
												
                                                <td class="product-price"><?php echo $date . ' ' . $time;?></span></td>
                                                <td class="product-code">৳ <?php echo $g_total;?></td>
                                                <td class="product-total"><?php 
													if ($activity == 1){echo "<span style='color:#de0000;font-weight: bold;'>Pending...</span>";} 
													if ($activity == 2){echo "<span style='color: #14a41f;font-weight: bold;'>Completed</span>";}
													?>	
												</td>
												 <td class="product-total"><a href="view_invoice.php?inID=<?php echo $order_id; ?>">View</a></td>
