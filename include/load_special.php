...
$query = "select * from  sd_item_l WHERE activity = 1 AND featured = 1 ORDER BY id DESC";
...
$query="select id, item_name from sd_item_l WHERE activity = 1 AND featured = 1 order by id DESC
...
$HTML='';
				...
				if ($stmt = $mysqli->prepare("SELECT id, item_name, price, discount_price, img1, discount_per
							 from sd_item_l WHERE activity = 1 AND featured = 1
