...
function changePagination(pageId){
     ...
     $.ajax({
           type: "POST",
           url: "apps/load_data/loadbrand.php",
           data:{
          pageId: pageId
    },
           cache: false,
  ...
  <title>View All Brand List</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
      <a href="add_new_brand" class="btn btn-lg btn-success  btn-raised btn-label" ><i class="fa fa-pencil-square-o"></i>&nbsp; Add New Brand<div class="ripple-container"></div></a>
          <p>
