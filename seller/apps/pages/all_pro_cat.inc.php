...
function changePagination(pageId){
  ...
  <title>View All Product's Category</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
      <a href="add_new_category" class="btn btn-lg btn-success  btn-raised btn-label" ><i class="fa fa-pencil-square-o"></i>&nbsp; Add New Category<div class="ripple-container"></div></a>
          <p>
