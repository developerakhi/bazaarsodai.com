<?php	ob_start();
		...
		include_once(PRIVATE_PATH . "/functions/brand_stm.php");
		 ?>
  <link rel="stylesheet" href="plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <title>Update A Brand Information</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
         <a href="view_all_brand" class="btn btn-lg btn-danger btn-raised btn-label" ><i class="fa fa-th-list"></i> &nbsp;View All Brands<div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update A Brand's Information</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <br/>
             ...
             <form action="apps/pages/update_brand_code.php" enctype="multipart/form-data"  method="POST">
             <input type="hidden" name="date" class="form-control" placeholder="Date" value="<?php echo date("Y-m-d"); ?>">
              <div class="box-body">

               <?php echo $data_output->form_data();?>  
