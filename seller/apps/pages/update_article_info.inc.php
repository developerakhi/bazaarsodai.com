...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			<a href="view_all_articles" class="btn btn-lg btn-danger btn-raised btn-label"><i class="fa fa-th-list"></i> &nbsp;View All Articles<div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update A Article</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <br/>
             Required Fields <span class="red_star">*</span>
						...
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                ...
                                <script type="text/javascript" src="dist/js/ajax-post.js"></script>
             ...
             <form action="apps/pages/update_post_code.php" enctype="multipart/form-data"  method="POST">
             <input type="hidden" name="date" class="form-control" placeholder="Date" value="<?php echo date("Y-m-d"); ?>">
              <div class="box-body">
               <div class="form-group">
               </div>
                <div class="form-group">
           			<?php echo $data_out->update_post();?>  
                </div>
