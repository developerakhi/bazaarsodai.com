        ...
        $stmt->bind_result($id, $color_code, $color_name);
				...
				while ($stmt->fetch()) { ?>               
                            <tr>
								...
								<td style="background-color:#<?php echo $color_code; ?>;"></td>
                              ...
                              <a href="apps/bin_cat/delete_cat.php?actionID=view_all_category&catID=<?php echo $id; ?>" class="btn btn-danger btn-raised btn-xs" data-toggle="tooltip" data-placement="top" title="Delete This Row" onClick="return confirm('Are you sure to Delete this Menu?')"><i class="fa fa-close"></i><div class="ripple-container"></div></a>
							</td>
                            </tr>
   						 	 <?php }
							   $stmt->close();
