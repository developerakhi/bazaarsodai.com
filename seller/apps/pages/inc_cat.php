...
testing_loggin();
 	...
 	if (isset($_POST['category_name'])) {
		...
		global $mysqli;
        if ($insert_stmt = $mysqli->prepare("INSERT INTO  menu (menu_name, meta_desc, meta_key, page_cn, img1, img2, type) VALUES (?, ?, ?, ?, ?, ?, ?)")) {
            $insert_stmt->bind_param('sssssss', $title, $meta_desc, $meta_key, $page_cn, $pro_img1, $pro_img2, $type);
