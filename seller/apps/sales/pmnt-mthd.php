...
function changePagination(pageId){
  ...
  <title>View All Payment Mathod's</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
      <a href="add_new_payment_mathod" class="btn btn-lg btn-success  btn-raised btn-label" ><i class="fa fa-pencil-square-o"></i>&nbsp; Add New Payment Mathod<div class="ripple-container"></div></a>
          <p>
