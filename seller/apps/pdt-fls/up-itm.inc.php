...
.wrap-custom-file label.file-ok .fa {
  ...
  <title>Update A Item's Information</title>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
         <a href="view_all_item" class="btn btn-lg btn-danger btn-raised btn-label" ><i class="fa fa-th-list"></i> &nbsp;View All Items<div class="ripple-container"></div></a>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update A Item's Information</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
         ...
         <form action="apps/pdt-fls/cd-up-itm.php" enctype="multipart/form-data"  method="POST">
             <input type="hidden" name="date" class="form-control" placeholder="Date" value="<?php echo date("Y-m-d"); ?>">
              <div class="box-body">
              
                <div class="form-group">
				
           			<?php echo $data_out->update_product();?>  
                </div>
              ...
              <button class="ladda-button" type="submit" name="submit" data-color="green" data-style="expand-right" data-size="l">Save Change</button>
