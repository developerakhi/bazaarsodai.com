        ...
        $stmt->bind_result($id, $p_name, $p_value, $position);
				...
				while ($stmt->fetch()) { ?>               
                            <tr>
                                ...
                                <td><?php if ($position == 1){echo "Dhaka";} if ($position == 2){echo "Out Of Dhaka";} ?></td>
                              ...
                              <a href="apps/bin_cat/delete_mathod.php?actionID=payment_mathod&catID=<?php echo $id; ?>" class="btn btn-danger btn-raised btn-xs" data-toggle="tooltip" data-placement="top" title="Delete This Row" onClick="return confirm('Are you sure to Delete this Mathod?')"><i class="fa fa-close"></i><div class="ripple-container"></div></a>
							</td>
                            </tr>
   						 	 <?php }
							   $stmt->close();
