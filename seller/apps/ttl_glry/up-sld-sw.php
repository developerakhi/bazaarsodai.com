...
$folder = "../../../images/slide/"; // folder where to save images
...
$write_thumbimage = $view .'/thumb-'. $image;
 switch($ext){
  case "gif":
...
<input type='text' name='pro_img2' value=". $write_thumbimage ." class='location corners' />
";
}
if ($thumb2 == 1){
echo "<img src='../images/slide/thumb3-".$image ."' alt='". $image ."' width='200px' />
