...
testing_loggin();
 	...
 	if (isset($_POST['sub_category_name'])) {
		...
		global $mysqli;
        if ($insert_stmt = $mysqli->prepare("INSERT INTO sub_menu (sub_menu, meta_desc, meta_key, page_cn, menu_id, img1, img2) VALUES (?, ?, ?,?, ?, ?,  ?)")) {
	  ...
	  header('Location: ../../add_new_sub_cat/545SD5/success');
 	}
