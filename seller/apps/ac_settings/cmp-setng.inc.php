        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Change Company Details</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <br/>
             Required Fields <span class="red_star">*</span>
             <form action="apps/ac_settings/upd_cpn.php" enctype="multipart/form-data"  method="POST">
              ...
              <div class="box-body">
                <div class="form-group">
						...
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								...
								?>
					<?php echo $data_out->company_data();?>           
                </div>
