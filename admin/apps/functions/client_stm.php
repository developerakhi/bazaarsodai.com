...
public function edit_profile() 
	{
			...
			<div class="form-group">
                <label>Email</label> 
				 <input type="hidden" name="id" placeholder="Item name" value="'.$client_id.'" class="form-control" required="required">
                    <input type="text" name="email" placeholder="e.g example@yourname.com" value="'.$email.'" class="form-control">
            </div>

            <div class="form-group">
                <label>Password <span class="red_star">*</span></label>
                <input type="password" id="password" name="password" placeholder="Password" value="'.$password.'" class="form-control" required="required">
            </div>
