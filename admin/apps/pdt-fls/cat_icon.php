...
$folder = "../../../images/icon/"; // folder where to save images
...
if ($thumb2 == 1){
echo "<img src='../images/icon/thumb2-".$image ."' width='50px' />
<input type='hidden' id='img2' name='pro_img2' value='thumb2-".$image ."' class='location corners' />
";
}
if ($thumb3 == 1){
echo "
<input type='hidden' name='photo' value='thumb3-".$image ."' class='location corners' />
";
}
