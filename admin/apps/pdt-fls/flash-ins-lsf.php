...
/*}*/
  ...
  <title>Add New Flash Deals</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
         <a href="view_all_flash_deals" class="btn btn-lg btn-success btn-raised btn-label" ><i class="fa fa-th-list"></i> &nbsp;View All Flash Deals<div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Flash Deals</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <br/>
             ...
             <form action="apps/pdt-fls/flash_ic.php" enctype="multipart/form-data"  method="POST">
				...
				<div class="box-body">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="product_id[]" multiple class='form-control'>
                            ...
                            <?php global $mysqli;
                                $stmt = $mysqli->prepare("SELECT id, item_name, item_code from sd_item_l 
                                  ORDER BY id ASC");
                                $stmt->execute();
                    ...
                    <div class="form-group col-md-3">
    					...
    					<input name="offer_name" type="text" class="form-control" id="offer_name" value="" autocomplete="off"  placeholder="Offer Name">
                    </div>
                    <div class="form-group col-md-3">
               			 <label>Title</label>
    					<input name="sub_title" type="text" class="form-control" id="sub_title" value="" autocomplete="off"  placeholder="Title">
                    </div>
                    <div class="form-group col-md-3">
               			 <label>Start Date </label>
    					<input type="datetime-local" class="form-control" name="start_date" placeholder="time">
                    </div>
                    <div class="form-group col-md-3">
               			 <label>End Date </label>
    					<input type="datetime-local" class="form-control" name="end_date" placeholder="time">
                    </div>
              </div>
              <!-- /.box-body -->
