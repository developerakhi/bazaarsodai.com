         ...
         <a href="view_all_coupon" class="btn btn-lg btn-success btn-raised btn-label" ><i class="fa fa-th-list"></i> &nbsp;View All Coupon<div class="ripple-container"></div></a>
          ...
          <div class="box box-primary">
            ...
            <br/>
             ...
             <form action="apps/pdt-fls/coupon_ic.php" enctype="multipart/form-data"  method="POST">
				...
				<div class="box-body">
                    <div class="form-group col-md-4">
    					...
    					<input name="coupon_code" type="text" class="form-control" value="" autocomplete="off"  placeholder="Coupon Code">
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
    					...
    					<input type="text" class="form-control" name="minimum_amount" placeholder="Minimum Amount">
                    </div>
                    <div class="form-group col-md-4">
