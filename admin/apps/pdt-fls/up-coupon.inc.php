...
global $mysqli;
$stmt = $mysqli->prepare("SELECT id, coupon_code, discount, minimum_amount, end_date FROM coupon where id = '".$url_string_id."' ");
$stmt->execute();   
$stmt->store_result();
         ...
         <a href="view_all_coupon" class="btn btn-lg btn-success btn-raised btn-label" ><i class="fa fa-th-list"></i> &nbsp;View All Coupon<div class="ripple-container"></div></a>
          ...
          <div class="box box-primary">
            ...
            <br/>
             ...
             <form action="apps/pdt-fls/cd-up-coupon.inc.php" enctype="multipart/form-data"  method="POST">
