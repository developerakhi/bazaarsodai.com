          ...
          <div class="col-md-6">
              <form action="" method="POST">
    			<div class="form-group col-md-12">
    				<label>Search Item Name And Category</label>
    				<input type="text" name="search" placeholder="<?php if ($search == NULL) {?>Item Name/Category Name<?php }else{ ?> <?php echo $search; ?> <?php }?>" class="form-control" required>    
