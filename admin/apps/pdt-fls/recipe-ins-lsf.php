...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
         <a href="view_all_recipe" class="btn btn-lg btn-danger btn-raised btn-label" ><i class="fa fa-th-list"></i> &nbsp;View All Recipe<div class="ripple-container"></div></a>
          <p>
          ...
          <div class="box box-primary">
            ...
            <br/>
             ...
             <form action="apps/pdt-fls/recipe_ic.php" enctype="multipart/form-data"  method="POST">
