...
function changePagination(pageId){
 ...
 $.ajax({
      type: "POST",
      url: "apps/statement/loadReports.php",
      data:{
...
<!-- Main content -->
    <section class="content">
        ...
        <!--				<input type="text" name="search" placeholder="<?php if ($search == NULL) {?>Date /Titel<?php }else{ ?> <?php echo $search; ?> <?php }?>" class="form-control" required>  -->
