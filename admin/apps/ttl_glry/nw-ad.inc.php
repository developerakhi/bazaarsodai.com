...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
         <a href="view_all_slide" class="btn btn-lg btn-success btn-raised btn-label" ><i class="fa fa-th-list"></i> &nbsp;View All Slide Images <div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Image In Slide</h3>
            </div>
            <!-- /.box-header -->
