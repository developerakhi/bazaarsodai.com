...
function changePagination(pageId){
 ...
 $.ajax({
      type: "POST",
      url: "apps/customer_client/loadCustomer.php",
      data:{
            ...
            <div class="col-md-6">
              <form action="" method="POST">
    			<div class="form-group col-md-12">
    				...
    				<input type="text" name="search" placeholder="<?php if ($search == NULL) {?>Customer Name/Mobile/Email<?php }else{ ?> <?php echo $search; ?> <?php }?>" class="form-control" required>  
