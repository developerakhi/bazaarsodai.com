 <title>Add New Payment Mathod</title>
        ...
        <a href="payment_mathod" class="btn btn-lg btn-danger btn-raised btn-label"><i class="fa fa-folder-o"></i> &nbsp;View All Payment Mathod<div class="ripple-container"></div></a>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Payment Mathod</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
       
       <form action="apps/sales/inc_mthd.php" enctype="multipart/form-data"  method="POST">
             <input type="hidden" name="date" class="form-control" placeholder="Date" value="<?php echo date("Y-m-d"); ?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="name" required placeholder="Mathod Name">
                </div>
                
               <div class="form-group">
                  <label for="exampleInputEmail1">Mathod Charge</label>
                  <input type="number" class="form-control" id="exampleInputEmail1" name="value" required placeholder="">
			 </div>
             ...
             <select name="type" class="form-control" required="">
                  ...
                  <option value="2">Out Of Dhaka</option>
