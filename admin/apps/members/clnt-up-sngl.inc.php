...
?>
 ...
 <title>Edit a Member's information</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
              <a href="view_all_customer" class="btn btn-lg btn-success btn-raised btn-label" ><i class="fa fa-users"></i> &nbsp;View All Member <div class="ripple-container"></div></a>
          <p>
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <br/>
                <span style="padding-left: 20px;">Required Fields </span><span class="red_star">*</span>
                        <div class="box-body">
								<?php 		
