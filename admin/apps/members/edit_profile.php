...
?>
 ...
 <title>Edit Admin Username OR Password</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Admin Username OR Password</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <br/>
             <p style="margin-left: 10px;">Required Fields <span class="red_star">*</span></p>
                        <div class="box-body">
								<?php 		
             ...
             <form action="apps/members/edit_profile_code.php" enctype="multipart/form-data"  method="POST">
             
              <div class="box-body">
               
                <div class="form-group">
                    <label>Email <span class="red_star">*</span></label> 
    				 <input type="hidden" name="id" placeholder="Item name" value="" class="form-control" required="required">
                        <input type="text" name="email" placeholder="e.g example@yourname.com" value="" class="form-control">
                </div>
    
                <div class="form-group">
                    <label>Password <span class="red_star">*</span></label>
                    <input type="password" id="password" name="password" placeholder="Password" value="" class="form-control" required="required">
                </div>
