...
function changePagination(pageId){
     ...
     $.ajax({
           type: "POST",
           url: "apps/load_data/load_size.php",
           data:{
          pageId: pageId
    },
           cache: false,
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
      <a href="add_new_size" class="btn btn-lg btn-success  btn-raised btn-label" ><i class="fa fa-pencil-square-o"></i>&nbsp; Add New Size<div class="ripple-container"></div></a>
          <p>
