 <title>Create New Headline | Dhaka Bazar</title>
        ...
        <a href="headlines" class="btn btn-lg btn-danger btn-raised btn-label"><i class="fa fa-folder-o"></i> &nbsp;View All Headlines<div class="ripple-container"></div></a>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Create New Headline</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
       
       <form action="apps/pages/hdl_go_cd.php" enctype="multipart/form-data"  method="POST">
            ...
            <div class="box-body">
                <div class="form-group">
                   <?php 		
						...
						<i class="fa fa-check"></i>&nbsp; <strong>Insert Successful!</strong>
                  ...
                  <label for="exampleInputEmail1">Headline Title</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="category_name" required placeholder="Headline Title">


                </div>
                
              <div class="form-group">
                <label for="exampleInputEmail1">Headline Url</label>
                <textarea name="link" class="form-control" id="exampleInputEmail1" placeholder="Article Link"></textarea>
