...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
        <a href="all_testimonial" class="btn btn-lg btn-danger btn-raised btn-label"><i class="fa fa-quote-left" aria-hidden="true"></i> &nbsp; All Testimonial<div class="ripple-container"></div></a>
          <p>
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
				...
				<form action="apps/pages/inc_testimonial.php" enctype="multipart/form-data"  method="POST">
