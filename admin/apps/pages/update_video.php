...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
        <a href="all_video" class="btn btn-lg btn-danger btn-raised btn-label" ><i class="fa fa-newspaper-o"></i> &nbsp; All Video<div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit A Video </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
					
                   
            <form action="apps/pages/up_video_code.php" enctype="multipart/form-data"  method="POST">
              ...
              <div class="box-body">
                <div class="form-group">
						...
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								...
								?>
					<?php echo $data_out->update_video();?>           
                </div>
