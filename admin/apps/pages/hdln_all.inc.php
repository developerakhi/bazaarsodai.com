...
function changePagination(pageId){
     ...
     $.ajax({
           type: "POST",
           url: "apps/load_data/loadhdl.php",
           data:{
          pageId: pageId
    },
           cache: false,
  ...
  <title>View All Headlines </title>
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>View All Headlines</h1>
      <ol class="breadcrumb">
        <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Article Management</li>
        <li class="active">View All Headlines</li>
      </ol>
    </section>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
      <a href="add_headline" class="btn btn-lg btn-success  btn-raised btn-label" ><i class="fa fa-pencil-square-o"></i>&nbsp; Add New Headline<div class="ripple-container"></div></a>
          <p>
