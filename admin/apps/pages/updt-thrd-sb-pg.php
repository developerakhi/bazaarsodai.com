<?php	require_once("apps/initialize.php"); 
		...
		?>
 <title>Edit a product's Third Sub category information</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
        <a href="view_all_third_sub_cat" class="btn btn-lg btn-danger btn-raised btn-label" ><i class="fa fa-folder-o"></i> &nbsp;View All Third Sub Category<div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit a product's Third Sub category information</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
           
                           	
             <form action="apps/nws/up-thrd-s_ct.php" enctype="multipart/form-data"  method="POST">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
						...
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
						  ...
						  echo $data_out->third_sub_cat_data();?>           
