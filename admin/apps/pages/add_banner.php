...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
        <a href="all_banner" class="btn btn-lg btn-success btn-raised btn-label"><i class="fa fa-folder-o"></i> &nbsp; All Banner<div class="ripple-container"></div></a>
          <p>
            ...
            <!-- form start -->
					...
					<?php 		
								...
								if ($u_link == "success"){
									...
									<i class="fa fa-check"></i>&nbsp; <strong>Insert Successful!</strong> Data Successfully Inserted 
				...
				<form action="apps/pages/inc_banner.php" enctype="multipart/form-data"  method="POST">
					
					<input type="hidden" name="date" class="form-control" value="<?php echo date("d-m-yy"); ?>">
					  <div class="box-body">
