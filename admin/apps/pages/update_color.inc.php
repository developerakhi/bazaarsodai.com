...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
        <a href="view_all_color" class="btn btn-lg btn-danger btn-raised btn-label" ><i class="fa fa-folder-o"></i> &nbsp;View All Colours<div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update A Colour</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
      
             
             <form action="apps/pages/upd_color.php" enctype="multipart/form-data"  method="POST">
