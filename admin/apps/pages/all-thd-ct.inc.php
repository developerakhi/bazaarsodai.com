...
function changePagination(pageId){
     ...
     $.ajax({
           type: "POST",
           url: "apps/load_data/loadt_sub_Dcat.php",
           data:{
          pageId: pageId
    },
           cache: false,
 ...
 <title>View All Product's Third Sub Categories</title>
...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
        <a href="add_new_third_sub_cat" class="btn btn-lg btn-success  btn-raised btn-label"><i class="fa fa-pencil-square-o"></i> &nbsp;Add New Third Sub Category<div class="ripple-container"></div></a>
          <p>
            <!-- general form elements -->
          </p>
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">View All Product's Third Sub Categories</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                     <div class="box-body">
