...
if ($stmt = $mysqli->prepare("SELECT id, username, name, email, mobile, address, delivery_address, date
FROM sd_client
WHERE id = ?
LIMIT 1")) {
...
$stmt->execute();    
$stmt->store_result();
$stmt->bind_result($user_id, $username1, $e_name, $e_email, $e_mobile, $e_address, $delivery_address, $e_date);
$stmt->fetch();
}	
?>
<!DOCTYPE html>
                    ...
                    <!--<div class="row gutters-10">-->
                        <div class="myaccount-content">
                            ...
                            <div class="account-details-form">
                                <form action="include/up_myaccount_address.php" method="POST">
                                    <input type="hidden" name="id" value="<?php echo $getID; ?>">
                                    <div class="">
                                        <div class="col-lg-12">
                                            <div class="single-input-item">
                                                <label for="first-name" class="required">Home Address</label>
                                                <input type="text" name="name" value="<?php echo $e_address; ?>" placeholder="Name">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="single-input-item">
                                                <label for="first-name" class="required">Dellivery Address</label>
                                                <input type="text" name="name" value="<?php echo $delivery_address; ?>" placeholder="Name">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="single-input-item">
                                                <label for="first-name" class="required">Mobile</label>
                                                <input type="text" name="mobile" value="<?php echo $e_mobile; ?>" placeholder="Mobile">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single-input-item">
