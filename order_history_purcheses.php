                                        ...
                                        <tbody>
                                               <?php 		
                                				...
                                				if ($stmt = $mysqli->prepare("SELECT id, order_id, customer_name, mobile, g_total, date, delivery_time, activity 
                                        				from sd_order_more 
                                        				WHERE customerID = '".$getID."'ORDER BY id DESC LIMIT 15")){
                                        				$stmt->execute();   
                                				...
                                				?>
                                                    <tr>
                                                        ...
                                                        <td><a href="myaccount_order_invoice.php" class="btn btn-success btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                                    </tr>
            									<?php }
                            					$stmt->close();
                            				?>
