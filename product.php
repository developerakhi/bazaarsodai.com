...
if ($stmt_m = $mysqli->prepare("SELECT 	sub_menu_id, sub_menu, menu_id,  meta_desc, meta_key, page_cn, img2 from sub_menu  WHERE sub_menu_id = ? ")){
$stmt_m->bind_param('i', $subcat); 
$stmt_m->execute();    
                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<?php 
								...
								echo'
										<div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 col-6 colum-section">
