            ...
            <div class="main" id="get_product">
				...
				<section class="all-category-panel min-vh-100">
                    <div class="container-fluid">
						...
						<?php 
							global $mysqli;
							if ($stmt_pro = $mysqli->prepare("SELECT id, shop_id, item_name, unit, price, quantity, discount_per, discount_price, delivery_charge, img1, img2 from sd_item_l
								WHERE activity = 1  AND free_delivery = 1 AND delivery_charge <= 0
								ORDER BY id DESC LIMIT 90")){
							$stmt_pro->execute(); 
							$stmt_pro->bind_result($item_id, $shop_id, $item_name, $unit, $price, $quantity, $discount_per, $discount_price, $delivery_charge, $img1, $img2);
