            ...
            <div class="main min-vh-100" id="get_product">
		        ...
		        <section class="all-category-panel ctpd2">
		           <div class="container-fluid">
		               <div class="row">
		                   <div class="col-md-12">
		                       <a href="#">
                                    <img width="100%" src="images/icon/category2.jpg" style="margin-bottom: 10px;">
                                </a>
		                   </div>
		               </div>
		           </div>
				...
				<section class="all-category-panel min-vh-100">
                    <div class="container-fluid">
						...
						<?php 
							global $mysqli;
							if ($stmt_pro = $mysqli->prepare("SELECT id, shop_id, item_name, unit, price, discount_per, discount_price, img1, img2 from sd_item_l
								WHERE activity = 1 AND get_discount = 1
								ORDER BY id DESC LIMIT 90")){
							$stmt_pro->execute(); 
								// Execute the prepared query.
								// get variables from result.
							$stmt_pro->bind_result($item_id, $shop_id, $item_name, $unit, $price, $discount_per, $discount_price, $img1, $img2);
