...
$userMobile = isset($_GET['mobileNo']) ? $_GET['mobileNo'] : '';
$query ="SELECT * FROM sd_client WHERE mobile ='$userMobile'";
$results = $mysqli->query($query);
$oldMobile = $results->fetch_assoc();

if ($userMobile != $oldMobile['mobile']) {
				...
				<section class="all-category-panel">
                    <div class="container-fluid">
						...
						<div class="col-md-3"> </div>
                            <div class="col-md-6">
                                <div class="otpbox fullCart-body bg- #ebedef  m-b-24">
								    <h2>Enter 5 Digits OTP</h2>
										...
										<div class="form-group m-b-24">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <input type="number" readonly class="form-control" placeholder="Mobile Number" value="<?php echo $userMobile; ?>" name="mobile_no">
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group m-b-24">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
													<label class="mb-0" for="CustomerName">Enter OTP (5 Digits)</label>
                                                    <input type="number" class="form-control" name="otp_number" placeholder="Enter OTP" required>
                                                </div>
                                            </div>
                                        </div>
										<div class="m-b-10 center">
										    <!--<div>Time left = <span id="timer"></span></div>-->
											<button type="submit" class="btn btn-round gb-gradient mx-4">Submit</button>
										</div>
                                    </form>
                                </div>      
                            </div>
